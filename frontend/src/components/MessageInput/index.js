...
const MessageInput = ({ ticketStatus }) => {
  ...
  const handleStartRecording = async () => {
    ...
    try {
      console.log("Solicitando permissão para o microfone...");
      ...
      if (err.name === "NotAllowedError") {
        toastError("Permissão para acessar o microfone foi negada.");
      } else if (err.name === "NotFoundError") {
        toastError("Nenhum dispositivo de microfone foi encontrado.");
      } else {
        toastError("Erro ao iniciar a gravação. Verifique as permissões do microfone.");
      }
      setLoading(false);
    }
  };
